...
@include('admin.partials.content-header',['name'=>"Phòng ban","key"=>"Thêm phòng ban"])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form class="form-horizontal" action="{{route('admin.room.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @error('name') is-invalid @enderror" id="name" value="{{ old('name') }}" name="name" placeholder="Nhập tên phòng ban">
                                                            @error('name')
                                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                                            @enderror
                                                        </div>
